...
## v3.4.3 layout change
- Moves **Stats / Dashboard**, **Backup GPS**, and **Restore GPS** to the very top of the app, above the Moelfre Daily Round Planner section.
- All v3.4.2 functions and data storage remain unchanged.
